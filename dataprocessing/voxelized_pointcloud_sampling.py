...
def voxelized_pointcloud_sampling(path):
    try:
        ...
        out_path = os.path.join(save_dir, cat_idx)
        ...
        out_file = os.path.join(out_path, file_name, 'voxelized_point_cloud_{}res_{}points.npz'.format(cfg.input_res, cfg.num_points))
