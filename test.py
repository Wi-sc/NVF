...
WORK_DIR = "./experiments/shapenet_cube_offset_generalization_pt_vq_k16"
OBJECTS_DIR_GT = "/home/xianghui_yang/data/NVF_data/"
OBJECTS_DIR = os.path.join(WORK_DIR, "mesh")
sys.stdout = open(os.path.join(WORK_DIR, "test_mesh.txt"), "w")
